    ...
    <div className="min-h-screen bg-white overflow-x-hidden font-sans selection:bg-[#2DD881] selection:text-black">
        ...
        <ScrollVelocity
          texts={[
            <span className="inline-flex items-center gap-4 whitespace-nowrap">
              <span className="bg-waxy-lime px-6 py-2 rounded-full text-black border border-black inline-flex items-center justify-center">
                Fashion & Beauty
              </span>
              <span className="bg-waxy-blue px-6 py-2 rounded-full text-black border border-black inline-flex items-center justify-center">
                Tech & Gadgets
              </span>
              <span className="bg-waxy-pink px-6 py-2 rounded-full text-black border border-black inline-flex items-center justify-center">
                Food & Cooking
              </span>
            </span>,
            <span className="inline-flex items-center gap-4 whitespace-nowrap">
              <span className="bg-waxy-yellow px-6 py-2 rounded-full text-black border border-black inline-flex items-center justify-center">
                Travel & Lifestyle
              </span>
              <span className="bg-waxy-mint px-6 py-2 rounded-full text-black border border-black inline-flex items-center justify-center">
                Gaming & Esports
              </span>
              <span className="bg-waxy-terracotta px-6 py-2 rounded-full text-black border border-black inline-flex items-center justify-center">
                Education
              </span>
            </span>,
          ]}
                ...
                content: (
                  <motion.div
                    ...
                    whileInView={{
                      opacity: 1,
                      scale: 1,
                      boxShadow: "0 0 60px -15px rgba(250, 204, 21, 0.6)",
                    }}
                    viewport={{ margin: "-100px" }}
                    transition={{ duration: 0.5 }}
                    className="bg-waxy-yellow p-8 rounded-3xl text-black shadow-lg"
                  >
                    <h3 className="font-airone font-bold text-2xl md:text-4xl mb-4 lowercase">
                      Pick your niche
                    </h3>
                    <p className="text-black/80 text-lg leading-relaxed font-medium">
                      Fashion, tech, finance, whatever. We track trends you care
                      about. Not the ones you don't.
                    </p>
                  </motion.div>
                ),
              },
                ...
                content: (
                  <motion.div
                    ...
                    whileInView={{
                      opacity: 1,
                      scale: 1,
                      boxShadow: "0 0 60px -15px rgba(132, 204, 22, 0.6)",
                    }}
                    viewport={{ margin: "-100px" }}
                    transition={{ duration: 0.5 }}
                  ...
                  >
                    <h3 className="font-airone font-bold text-2xl md:text-4xl mb-4 lowercase">
                      We predict the collapse
                    </h3>
                    <p className="text-black/80 text-lg leading-relaxed font-medium">
                      Our AI spots engagement drops, influencer exodus,
                      saturation, algorithm shifts. The stuff you miss while
                      sleeping.
                    </p>
                  </motion.div>
                ),
                ...
                content: (
                  <motion.div
                    ...
                    whileInView={{
                      opacity: 1,
                      scale: 1,
                      boxShadow: "0 0 60px -15px rgba(236, 72, 153, 0.6)",
                    }}
                    viewport={{ margin: "-100px" }}
                    transition={{ duration: 0.5 }}
                  ...
                  >
                    ...
                    <p className="text-black/80 text-lg leading-relaxed font-medium">
                      Green? Ship it. Yellow? Reconsider. Red? We'll swap it for
                      something that's actually rising. Your choice.
                    </p>
                  </motion.div>
                ),
              },
      ...
      <section className="py-24 px-6 bg-white text-black border-t border-gray-100">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="font-airone text-4xl md:text-6xl font-bold mb-4 lowercase">
              We show our work.
            </h2>
            <p className="text-xl text-gray-600">
              Because 'trust the algorithm' is a terrible answer.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Likes and shares down 30% week-over-week? We flag it yellow. Down 50%? Red. Math, not magic.",
                color: "bg-waxy-blue",
              },
              {
                title: "Influencer exodus",
                desc: "When top creators stop using a trend, everyone else follows. We track who's bailing. You get the heads up.",
                color: "bg-waxy-mint",
              },
              {
                title: "Content saturation",
                desc: "Ten thousand videos using the same audio this week versus two thousand last week? Oversaturated. We'll tell you to skip it.",
                color: "bg-waxy-yellow",
              },
              {
                title: "Algorithm penalties",
                desc: "Platform changed what it promotes? We detect it, explain it, and suggest alternatives. No guessing required.",
                color: "bg-waxy-pink",
              },
            ].map((item, i) => (
              <div
                key={i}
                className={cn(
                  "p-8 rounded-3xl transition-transform hover:scale-[1.02] text-black",
                  item.color,
                )}
              >
                <h3 className="font-airone font-bold text-xl mb-3 lowercase">
                  {item.title}
                </h3>
      ...
      <section className="py-24 px-6 bg-black text-white border-t border-white/10">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="font-airone text-4xl md:text-6xl font-bold lowercase">
            ...
            {[
              {
                stat: "87%",
                label: "accuracy",
                sub: "We're right most of the time. Better odds than your gut feeling.",
              },
              {
                stat: "2.3x",
                label: "engagement",
                sub: "Average boost for users who listen to the warnings instead of ignoring them.",
              },
              {
                stat: "12hr",
                label: "head start",
                sub: "Spot decline half a day before your competitors notice something's wrong.",
              },
              {
                stat: "64%",
                label: "less wasted",
                sub: "Stop throwing content at trends that are already dead.",
              },
            ].map((item, i) => (
              <div key={i} className="text-center">
                <div className="font-airone font-bold text-5xl md:text-6xl mb-2 text-white">
                  {item.stat}
                </div>
                <div className="font-bold text-lg mb-4 text-waxy-lime lowercase">
                  {item.label}
                </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
            <div className="md:col-span-1">
              ...
              <p className="text-gray-500 leading-relaxed">
                Spot trends before they die. The only analytics tool that tells
                you when to stop posting.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-100 pt-8">
            <p className="text-gray-400 text-sm">
              © 2026 <span className="font-bold">the decay</span>. All rights
              reserved.
            </p>
