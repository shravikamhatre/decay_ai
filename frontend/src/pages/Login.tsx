  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 grain-overlay">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="warm-blob warm-blob-amber w-[500px] h-[500px] top-0 left-1/2 -translate-x-1/2 -translate-y-1/4" />
        <div className="warm-blob warm-blob-orange w-[300px] h-[300px] bottom-1/4 right-0 translate-x-1/3" style={{ animationDelay: '3s' }} />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-2xl font-display font-bold text-foreground">Shelf Life</span>
          </Link>
