...
const getOptionStyles = (color: string, isSelected: boolean) => {
  if (!isSelected)
    return "bg-zinc-900/50 text-zinc-400 border-zinc-800 hover:border-zinc-700 hover:text-white";
...
const getIconStyles = (color: string, isSelected: boolean) => {
  ...
  switch (color) {
    case "waxy-yellow":
      return "bg-waxy-yellow/20 text-waxy-yellow";
    case "waxy-lime":
      return "bg-waxy-lime/20 text-waxy-lime";
    case "waxy-blue":
      return "bg-waxy-blue/20 text-waxy-blue";
    case "waxy-pink":
      return "bg-waxy-pink/20 text-waxy-pink";
    case "waxy-terracotta":
      return "bg-waxy-terracotta/20 text-waxy-terracotta";
    default:
...
const getCheckColor = (color: string) => {
  switch (color) {
    case "waxy-yellow":
      return "text-waxy-yellow";
    case "waxy-lime":
      return "text-waxy-lime";
    case "waxy-blue":
      return "text-waxy-blue";
    case "waxy-pink":
      return "text-waxy-pink";
    case "waxy-terracotta":
      return "text-waxy-terracotta";
    default:
      return "text-white";
  }
};
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="px-6 md:px-12 pt-8 pb-6 border-b border-zinc-800">
        ...
        <p className="text-zinc-400 mt-2">
          help us tailor your growth strategy
        </p>
      </div>
      ...
      <div className="px-6 md:px-12 py-8 max-w-4xl mx-auto space-y-12">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-airone text-3xl font-bold lowercase">
              i want my content to be more...
            </h2>
          </div>
